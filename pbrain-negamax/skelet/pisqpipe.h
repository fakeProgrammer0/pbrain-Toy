...
// 变量 terminate 和stl的一些函数命名相同，导致命名冲突，都include不了库了，shit
//extern int terminate; /* return from brain_turn when terminate>0 */
extern int terminate_v; /* return from brain_turn when terminate>0 */
...
extern const char* mySymbol;
extern const char* opponentSymbol;
extern int moveID;
